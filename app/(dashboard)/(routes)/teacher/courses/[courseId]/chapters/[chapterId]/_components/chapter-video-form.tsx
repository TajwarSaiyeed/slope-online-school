        ...
        {!isEditing && (
            !initialData.videoUrl ? (
                ...
                <div className={'relative aspect-video mt-2'}>
                    <iframe allowFullScreen={true} className={'w-full h-full rounded-md'} src={initialData.videoUrl}>
                    </iframe>
                    ...
                    <FormField render={({field}) => (<FormItem>
                        <FormControl>
                            <Input
                                ...
                                {...field} id={'videoUrl'} placeholder={"e.g. 'Enter the video url...'"}/>
                        </FormControl>
                        <FormMessage/>
                    </FormItem>)} name={'videoUrl'} control={form.control}/>
